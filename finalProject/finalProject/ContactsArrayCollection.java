...
public class ContactsArrayCollection extends ArrayCollection<Contacts> {
   ...
   public void merge (int leftFirst, int leftLast, int rightFirst, int rightLast, int field, int ascOrDesc) {
   ...
   public void mergeSort(int first, int last, int field, int ascOrDesc) {
      if (first < last) {
   ...
   public void sortElements(int field, int ascOrDesc) {
	   //System.out.println("ass-desc"+ ascOrDesc);
   ...
   public int removeElementByIndex(int i) {
   ...
   public Contacts[] filterElements(int field, String filterTerm) {
      if(field == 1) {
